...
function Footer() {
  ...
  <div className="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
    <div className="relative w-full">
      ...
      <input className="block p-2 pl-10 w-full text-sm text-gray-900 rounded-lg border border-slate-500 sm:rounded-none sm:rounded-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:purple-500 dark:placeholder-black-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="  Enter your email" type="email" id="email" required=""/>
    </div>
    <div className='ml-2'>
