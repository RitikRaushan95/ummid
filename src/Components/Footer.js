...
function Footer() {
  return (
    <>
      ...
      <footer>
        <div className="container px-5 py-1 mx-auto flex items-center sm:flex-row flex-col text-black justify-between">
          <div>
  ...
  <div className="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
    <div className="relative w-full">
      ...
      <input className="block p-2 pl-10 w-full text-sm text-gray-900 rounded-xl border border-slate-500 sm:rounded-none sm:rounded-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:purple-500 dark:placeholder-black-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="  Enter your email" type="email" id="email" required=""/>
    </div>
    <div className='ml-2'>
      <button type="submit" className="py-2 w-24 text-sm font-semibold text-center text-blaCK rounded-lg border cursor-pointer bg-purple-500 border-purple-500 sm:rounded-lg hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 hover:bg-purple-900">Subscribe</button>
    </div>
  </div>
</form>
